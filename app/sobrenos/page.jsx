    ...
    return (
        ...
        <div className={styles.container}>
            ...
            <div className={styles.cardContainer}>
                ...
                <IntegranteCash nome="Gabriel Picirile" cargo="CIO" foto="https://i.imgur.com/GUvnMes.jpg" description="José é o CIO da empresa e é responsável por gerenciar a equipe e as tarefas." />
