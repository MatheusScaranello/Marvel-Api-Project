    ...
    <footer className={styles.site-Footer}>
      <div className={styles.container}>
        <div className={styles.row}>
          ...
          <div className={styles.col-xs-6 .col-md-3}>
            <h6>Categories</h6>
      ...
      <div className={styles.container}>
        <div className={styles.row}>
          <div className={styles.col-md-8 .col-sm-6 .col-xs-12}>
            <p className={styles.copyright-text}>Copyright &copy; 2017 All Rights Reserved by 
         <a href="#">Scanfcode</a>.
            </p>
          </div>

          <div className={styles.col-md-4 .col-sm-6 .col-xs-12}>
            <ul className={styles.social-icons}>
              ...
              <li><a className={styles.linkedin} href="#"><i class={styles.fa .fa-linkedin}></i></a></li>   
            </ul>
          </div>
        </div>
      </div>
