         ...
         <a href="./sobrenos">6Devs</a>.
          ...
          <div className={styles.col}>
            <ul className={styles.social}>
              <li><a className={styles.facebook} target="_black" href="https://linktr.ee/6d3vs73?utm_source=linktree_profile_share&ltsid=38173729-06e5-4dd6-a081-623f1d3d04a3"><SiLinktree/></a></li>
